...
namespace ER_Ejercicio2tablas.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(ER_Ejercicio2DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'ER_Ejercicio2DbContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ER_Ejercicio2DbContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
