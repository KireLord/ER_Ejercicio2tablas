...
namespace ER_Ejercicio2tablas.Controllers
{
    public class PromosController : Controller
    {
        private readonly ER_Ejercicio2DbContext _context;

        public PromosController(ER_Ejercicio2DbContext context)
        {
            _context = context;
        }
        ...
        {
            var eR_Ejercicio2DbContext = _context.Promo.Include(p => p.Burger);
            return View(await eR_Ejercicio2DbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ER_Ejercicio2DbContext.Promo'  is null.");
            }
            var promo = await _context.Promo.FindAsync(id);
            if (promo != null)
            {
